     ...
     return (
          <div className="grid md:gap-10 grid-cols-3 min-h-screen">
               ...
               <section className="hidden md:col-span-1 lg:col-span-2 md:flex justify-center items-center">
                    <div className="lg:w-[70%] px-5 space-y-10 flex flex-col">
                         ...
                         <img className="rounded-lg" src="https://t4.ftcdn.net/jpg/11/82/20/55/240_F_1182205515_128Zp1g6WVPVOiMAR6awhhd9ZRC66U1k.jpg" alt="" />
                    </div>
               </section>
          </div>
     )
